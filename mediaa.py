...
import urllib.request # for using urlopen function
...
def getMovieDetail(id):
    connection = urllib.request.urlopen("https://api.themoviedb.org/3/movie/"+id+"?api_key=fad4cc55173a7da4b7b2aac1142fc037")  # opening url
